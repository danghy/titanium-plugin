...
module_defaults = {
    'description':'Wrapper that provides access to iPhone\'s Advertising Identifier (IFA).',
    'author': 'HasOffers Inc',
    'license' : 'Apache License, Version 2.0',
    'copyright' : 'Copyright (c) %s by HasOffers Inc' % str(date.today().year),
}
module_license_default = "http://www.apache.org/licenses/LICENSE-2.0"
...
def compile_js(manifest,config):
    js_file = os.path.join(cwd,'assets','com.temp.temp1.js')
...
""" % module_assets
    ...
    assets_router = os.path.join(cwd,'Classes','ComTempTemp1ModuleAssets.m')
