...
module_license_default = "Apache License, Version 2.0"
...
def compile_js(manifest,config):
    js_file = os.path.join(cwd,'assets','ti.mobileapptracker.js')
...
""" % module_assets
    ...
    assets_router = os.path.join(cwd,'Classes','TiMobileapptrackerModuleAssets.m')
